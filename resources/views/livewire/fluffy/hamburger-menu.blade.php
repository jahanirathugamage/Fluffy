<div>
    ...
    <div
        class="fixed inset-y-0 left-0 w-full md:w-72 bg-[#4FB5D0] text-white z-50 transform transition-transform duration-200 ease-in-out {{ $isOpen ? 'translate-x-0' : '-translate-x-full' }} shadow-lg"
    >
        <div class="flex flex-col h-full">

            {{-- Header (Desktop only — mobile header is your navbar in the screenshot) --}}
            ...
            <div class="flex-1 overflow-y-auto p-6 md:p-4">
                ...
                @if($currentLevel === 'main')
                    <ul class="space-y-4">
                        ...
                        <li class="flex items-center justify-between">
                            <a href="{{ route('orders.index') }}" wire:click="close"
                               class="block text-white font-[Montserrat] text-[16px] font-medium hover:font-bold">
                                Orders
                            </a>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" class="w-4 h-4 fill-white">
                ...
                @if($currentLevel === 'otherPets')
                    <div class="mb-6">
                        <button type="button" wire:click="goBack"
                                class="flex items-center gap-2 text-white font-[Montserrat] text-[16px] font-medium hover:font-bold">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" class="w-4 h-4 fill-white">
            ...
            {{-- Bottom white area --}}
            <div class="bg-white w-full p-8 flex items-center justify-center">
                {{-- Desktop: Logout only --}}
