<div class="max-w-4xl mx-auto py-10 px-4">
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-semibold">Edit Product #{{ $product->id }}</h1>
        ...
        <div>
            ...
            @if($current_image_path)
                <div class="mb-3">
                    ...
                    <img src="{{ asset($current_image_path) }}" class="h-24 w-24 object-cover rounded border" />
                </div>
            @endif
            ...
            @if ($image)
                <div class="mt-3">
                    <div class="text-sm text-gray-600 mb-2">New Preview</div>
            ...
            <div class="space-y-4">
                @foreach($specs as $i => $spec)
                    @if(!empty($spec['delete']))
                        <div class="p-4 rounded border bg-red-50 text-red-800">
                            This specification will be deleted.
                            <button type="button"
                                    wire:click="$set('specs.{{ $i }}.delete', false)"
